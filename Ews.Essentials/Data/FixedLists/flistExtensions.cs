...
namespace Ews.Essentials.Data
{
    ...
    public static class FixedListExtensions
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ref T rat<T>(this ref flist4<T> list, int index)
            where T : unmanaged
        {
            switch (index)
            {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ref T ratr<T>(this ref flist4<T> list, int index)
            where T : unmanaged => ref rat(ref list, list.Count - 1 - index);

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ref readonly T rrat<T>(this in flist4<T> list, int index)
            where T : unmanaged
        {
            switch (index)
            {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ref readonly T rratr<T>(this in flist4<T> list, int index)
            where T : unmanaged => ref rrat(in list, list.Count - 1 - index);

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ref T rat<T>(this ref flist8<T> list, int index)
            where T : unmanaged
        {
            switch (index)
            {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ref T ratr<T>(this ref flist8<T> list, int index)
            where T : unmanaged => ref rat(ref list, list.Count - 1 - index);

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ref readonly T rrat<T>(this in flist8<T> list, int index)
            where T : unmanaged
        {
            switch (index)
            {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ref readonly T rratr<T>(this in flist8<T> list, int index)
            where T : unmanaged => ref rrat(in list, list.Count - 1 - index);

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ref T rat<T>(this ref flist16<T> list, int index)
            where T : unmanaged
        {
            switch (index)
            {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ref T ratr<T>(this ref flist16<T> list, int index)
            where T : unmanaged => ref rat(ref list, list.Count - 1 - index);

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ref readonly T rrat<T>(this in flist16<T> list, int index)
            where T : unmanaged
        {
            switch (index)
            {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ref readonly T rratr<T>(this in flist16<T> list, int index)
            where T : unmanaged => ref rrat(in list, list.Count - 1 - index);

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ref T rat<T>(this ref flist32<T> list, int index)
            where T : unmanaged
        {
            switch (index)
            {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ref T ratr<T>(this ref flist32<T> list, int index)
            where T : unmanaged => ref rat(ref list, list.Count - 1 - index);

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ref readonly T rrat<T>(this in flist32<T> list, int index)
            where T : unmanaged
        {
            switch (index)
            {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ref readonly T rratr<T>(this in flist32<T> list, int index)
            where T : unmanaged => ref rrat(in list, list.Count - 1 - index);

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ref T rat<T>(this ref flist128<T> list, int index)
            where T : unmanaged
        {
            switch (index)
            {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ref T ratr<T>(this ref flist128<T> list, int index)
            where T : unmanaged => ref rat(ref list, list.Count - 1 - index);

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ref readonly T rrat<T>(this in flist128<T> list, int index)
            where T : unmanaged
        {
            switch (index)
            {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ref readonly T rratr<T>(this in flist128<T> list, int index)
            where T : unmanaged => ref rrat(in list, list.Count - 1 - index);
    }
}