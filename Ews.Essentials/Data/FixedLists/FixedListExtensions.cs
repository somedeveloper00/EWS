...
namespace Ews.Essentials.Data
{
    public static class FixedListExtensions
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ref readonly T rrefat<T>(this in FixedList4<T> list, int index)
            where T : unmanaged
        {
            switch (index)
            {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ref readonly T rrefat<T>(this in FixedList8<T> list, int index)
            where T : unmanaged
        {
            switch (index)
            {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ref readonly T rrefat<T>(this in FixedList16<T> list, int index)
            where T : unmanaged
        {
            switch (index)
            {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ref T refat<T>(this ref FixedList32<T> list, int index)
            where T : unmanaged
        {
            switch (index)
            {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ref readonly T rrefat<T>(this in FixedList32<T> list, int index)
            where T : unmanaged
        {
            switch (index)
            {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ref T refat<T>(this ref FixedList128<T> list, int index)
            where T : unmanaged
        {
            switch (index)
            {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ref readonly T rrefat<T>(this in FixedList128<T> list, int index)
            where T : unmanaged
        {
            switch (index)
            {
